...
public class StudentsProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.example.android_content_provider.StudentsProvider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            ...
            case STUDENTS:
                return "vnd.android.cursor.dir/vnd.example.android_content_provider.students";
            /*
             * Get a particular student
             */
            case STUDENT_ID:
                return "vnd.android.cursor.item/vnd.example.android_content_provider.students";
            default:
